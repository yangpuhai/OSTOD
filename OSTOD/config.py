...
def get_args():
    ...
    parser.add_argument("--GPU", type=int, default=4, help="number of gpu to use")
    parser.add_argument("--scale", type=float, default=1.0, help="training set scale")
    parser.add_argument("--mode", type=str, default="train", help="train or test or retelling_test")
